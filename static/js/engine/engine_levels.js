...
const LEVELS = {
  ...
  9: {
    ...
    10: {
      //Level 10-1
      1:[
        OrangeSquare(LEVEL_X + 120, LEVEL_Y - 90, 0, true),
        OrangeSquare(LEVEL_X + 10, LEVEL_Y - 90, 0, true),
        OrangeSquare(LEVEL_X - 100, LEVEL_Y - 90, 0, true),
        OrangeSquare(LEVEL_X - 210, LEVEL_Y - 90, 0, true),
        PurpleDiamond(LEVEL_X - 195, LEVEL_Y - 250, 61, true),
        PurpleDiamond(LEVEL_X - 75, LEVEL_Y - 250, 61, true),
        PurpleDiamond(LEVEL_X + 50, LEVEL_Y - 250, 61, true),
        GreenEquilateralTriangle(LEVEL_X + 200, LEVEL_Y - 140, 0, true),
        RedCircle(LEVEL_X + 100, LEVEL_Y + 20, 0, true),
        RedCircle(LEVEL_X - 180, LEVEL_Y + 20, 0, true),
      ],
     //Level 10-2
      2:[
        GreenEquilateralTriangle(LEVEL_X + 0, LEVEL_Y - 180, 0, true),
        GreenEquilateralTriangle(LEVEL_X + 0, LEVEL_Y - 120, 180, true),
        GreenEquilateralTriangle(LEVEL_X + 50, LEVEL_Y - 90, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 50, LEVEL_Y - 90, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 100, LEVEL_Y - 120, 180, true),
        GreenEquilateralTriangle(LEVEL_X + 100, LEVEL_Y - 120, 180, true),
        GreenEquilateralTriangle(LEVEL_X + 150, LEVEL_Y - 90, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 150, LEVEL_Y - 90, 0, true),
        GreenEquilateralTriangle(LEVEL_X + 0, LEVEL_Y - 0, 0, true),
        GreenEquilateralTriangle(LEVEL_X + 0, LEVEL_Y + 60, 180, true),
        GreenEquilateralTriangle(LEVEL_X - 50, LEVEL_Y + 90, 0, true),
        GreenEquilateralTriangle(LEVEL_X + 50, LEVEL_Y + 90, 0, true),
        GreenEquilateralTriangle(LEVEL_X + 100, LEVEL_Y + 60, 180, true),
        GreenEquilateralTriangle(LEVEL_X - 100, LEVEL_Y + 60, 180, true),
        GreenEquilateralTriangle(LEVEL_X + 100, LEVEL_Y - 0, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 100, LEVEL_Y - 0, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 50, LEVEL_Y - 30, 180, true),
        GreenEquilateralTriangle(LEVEL_X + 50, LEVEL_Y - 30, 180, true),
        GreenEquilateralTriangle(LEVEL_X - 150, LEVEL_Y - 30, 180, true),
        GreenEquilateralTriangle(LEVEL_X + 150, LEVEL_Y - 30, 180, true),
      ],
     //Level 10-3
      3:[
        PurpleDiamond(LEVEL_X - 50, LEVEL_Y + 0, 0, true),
        PurpleDiamond(LEVEL_X - 50, LEVEL_Y + 200, 0, true),
        PurpleDiamond(LEVEL_X + 40, LEVEL_Y + 48, 58, true),
        PurpleDiamond(LEVEL_X - 140, LEVEL_Y + 48, 302, true),
        PurpleDiamond(LEVEL_X - 140, LEVEL_Y + 152, 60, true),
        PurpleDiamond(LEVEL_X + 40, LEVEL_Y + 152, 300, true),
      ]
    },
   11: {
      //Level 11-1
      1:[
        BlueHexagon(LEVEL_X - 0, LEVEL_Y - 200, 90, true),
        BlueHexagon(LEVEL_X - 77, LEVEL_Y - 65, 90, true),
        BlueHexagon(LEVEL_X + 77, LEVEL_Y - 65, 90, true),
        BlueHexagon(LEVEL_X - 0, LEVEL_Y + 70, 90, true),
        BlueHexagon(LEVEL_X - 155, LEVEL_Y + 70, 90, true),
        BlueHexagon(LEVEL_X + 155, LEVEL_Y + 70, 90, true),
      ],
       //Level 11-2 (Paper Hat 257)
      2:[
        OrangeSquare(LEVEL_X - 50, LEVEL_Y - 200, 45, true),
        BlueRightTriangle(LEVEL_X - 125, LEVEL_Y - 125, 45, true),
        BlueRightTriangle(LEVEL_X + 25, LEVEL_Y - 125, 45, true),
        BlueRightTriangle(LEVEL_X - 125, LEVEL_Y - 50, 45, true),
        BlueRightTriangle(LEVEL_X + 25, LEVEL_Y - 50, 45, true),
        BlueRightTriangle(LEVEL_X - 200, LEVEL_Y - 122, 225, true),
        BlueRightTriangle(LEVEL_X - 50, LEVEL_Y - 122, 225, true),
        BlueRightTriangle(LEVEL_X + 100, LEVEL_Y - 122, 225, true),
      ],
     //Level 11-3 (OK 258)
      3:[
        PinkQuarterCircle(LEVEL_X - 50, LEVEL_Y - 100, 225, true),
        PinkQuarterCircle(LEVEL_X - 50, LEVEL_Y - 95, 45, true),
        PinkQuarterCircle(LEVEL_X - 55, LEVEL_Y - 96, 135, true),
        OrangeSquare(LEVEL_X - 25, LEVEL_Y - 147, 45, true),
        OrangeSquare(LEVEL_X + 100, LEVEL_Y - 200, 0, true),
        OrangeSquare(LEVEL_X + 100, LEVEL_Y - 95, 0, true),
        BlueRightTriangle(LEVEL_X + 205, LEVEL_Y - 200, 0, true),
        BlueRightTriangle(LEVEL_X + 205, LEVEL_Y - 95, 270, true),
      ]
    },
   12: {
      //Level 12-1 (Snow Angel 259)
      1:[
        RedCircle(LEVEL_X - 50, LEVEL_Y - 200, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y - 100, 0, true),
        YellowDiamond(LEVEL_X - 150, LEVEL_Y - 131, 45, true),
        YellowDiamond(LEVEL_X + 80, LEVEL_Y - 131, 135, true),
        PurpleDiamond(LEVEL_X - 20, LEVEL_Y - 40, -60, true),
        GreenEquilateralTriangle(LEVEL_X - 50, LEVEL_Y + 80, -0, true),
      ],
     //Level 12-2 (Car 178)
      2:[
        BlueHexagon(LEVEL_X - 150, LEVEL_Y - 0, 0, true),
        BlueHexagon(LEVEL_X + 150, LEVEL_Y - 0, 0, true),
        GreenTrapezoid(LEVEL_X - 100, LEVEL_Y - 73, 0, true),
        GreenTrapezoid(LEVEL_X - 100, LEVEL_Y - 180, 180, true),
        GreenTrapezoid(LEVEL_X - 254, LEVEL_Y - 180, 0, true),
        GreenTrapezoid(LEVEL_X + 55, LEVEL_Y - 180, 0, true),
        GreenTrapezoid(LEVEL_X + 175, LEVEL_Y - 115, 65, true),
        GreenTrapezoid(LEVEL_X + 270, LEVEL_Y - 164, 245, true),
        GreenTrapezoid(LEVEL_X - 480, LEVEL_Y - 120, 65, true),
        GreenTrapezoid(LEVEL_X - 385, LEVEL_Y - 163, 245, true),
        GreenTrapezoid(LEVEL_X + 100, LEVEL_Y - 300, 65, true),
        GreenTrapezoid(LEVEL_X - 300, LEVEL_Y - 300, -65, true),
        PurpleDiamond(LEVEL_X - 150, LEVEL_Y - 420, -60, true),
        PurpleDiamond(LEVEL_X + 40, LEVEL_Y - 420, 60, true),
        GreenEquilateralTriangle(LEVEL_X + 0, LEVEL_Y - 340, 180, true),
        GreenEquilateralTriangle(LEVEL_X - 50, LEVEL_Y - 210, 0, true),
      ],
     //Level 12-3 (Big Square 235)
      3:[
        OrangeSquare(LEVEL_X - 160, LEVEL_Y + 110, 0, true),
        OrangeSquare(LEVEL_X + 60, LEVEL_Y + 110, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y + 110, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y - 0, 0, true),
        OrangeSquare(LEVEL_X - 160, LEVEL_Y - 0, 0, true),
        OrangeSquare(LEVEL_X + 60, LEVEL_Y - 0, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y - 110, 0, true),
        OrangeSquare(LEVEL_X - 160, LEVEL_Y - 110, 0, true),
        OrangeSquare(LEVEL_X + 60, LEVEL_Y - 110, 0, true),
      ]
   ...
   13: {
      //Level 13-1 (W 207)
      1:[
        PinkQuarterCircle(LEVEL_X - 5, LEVEL_Y + 0, 180, true),
        PinkQuarterCircle(LEVEL_X + 5, LEVEL_Y + 0, 270, true),
        GreenTrapezoid(LEVEL_X - 190, LEVEL_Y + 30, 117, true),
        GreenEquilateralTriangle(LEVEL_X - 160, LEVEL_Y + 160, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 160, LEVEL_Y + 220, 180, true),
        GreenTrapezoid(LEVEL_X - 10, LEVEL_Y + 30, -117, true),
        GreenEquilateralTriangle(LEVEL_X + 160, LEVEL_Y + 160, 0, true),
        GreenEquilateralTriangle(LEVEL_X + 160, LEVEL_Y + 220, 180, true),
        GreenTrapezoid(LEVEL_X + 130, LEVEL_Y + 30, 117, true),
        GreenTrapezoid(LEVEL_X - 330, LEVEL_Y + 30, -117, true),
        PurpleDiamond(LEVEL_X - 348, LEVEL_Y - 140, 118, true),
        PurpleDiamond(LEVEL_X + 240, LEVEL_Y - 140, -118, true),
      ],
     //Level 13-2 (B 186)
      2:[
        OrangeSquare(LEVEL_X - 50, LEVEL_Y + 150, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y + 0, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y - 150, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 90, LEVEL_Y - 100, 30, true),
        GreenEquilateralTriangle(LEVEL_X - 90, LEVEL_Y + 200, 30, true),
        GreenEquilateralTriangle(LEVEL_X - 130, LEVEL_Y + 150, 210, true),
        GreenEquilateralTriangle(LEVEL_X - 130, LEVEL_Y - 50, 210, true),
        GreenTrapezoid(LEVEL_X - 205, LEVEL_Y - 0, 90, true),
        PinkQuarterCircle(LEVEL_X + 60, LEVEL_Y + 150, 0, true),
        PinkQuarterCircle(LEVEL_X + 60, LEVEL_Y + 145, -90, true),
        PinkQuarterCircle(LEVEL_X + 60, LEVEL_Y - 45, 0, true),
        PinkQuarterCircle(LEVEL_X + 60, LEVEL_Y - 55, -90, true),
      ],
     //Level 13-3 (L 196)
      3:[
        OrangeSquare(LEVEL_X - 50, LEVEL_Y + 0, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y - 213, 0, true),
        OrangeSquare(LEVEL_X + 53, LEVEL_Y + 210, 0, true),
        BlueRightTriangle(LEVEL_X - 50, LEVEL_Y + 102, 0, true),
        BlueRightTriangle(LEVEL_X - 50, LEVEL_Y + 105, 180, true),
        BlueRightTriangle(LEVEL_X - 50, LEVEL_Y - 108, 0, true),
        BlueRightTriangle(LEVEL_X - 50, LEVEL_Y - 106, 180, true),
        BlueRightTriangle(LEVEL_X + 160, LEVEL_Y + 210, 0, true),
        BlueRightTriangle(LEVEL_X + 165, LEVEL_Y + 210, 180, true),
        PinkQuarterCircle(LEVEL_X + 48, LEVEL_Y + 210, 90, true),
      ]
    },
   14: {
      //Level 14-1 (Berry 251)
      1:[
        OrangeSquare(LEVEL_X - 110, LEVEL_Y + 0, 0, true),
        OrangeSquare(LEVEL_X - 0, LEVEL_Y + 0, 0, true),
        OrangeSquare(LEVEL_X - 110, LEVEL_Y + 110, 0, true),
        OrangeSquare(LEVEL_X - 0, LEVEL_Y + 110, 0, true),
        GreenEquilateralTriangle(LEVEL_X - 40, LEVEL_Y - 60, 20, true),
        GreenEquilateralTriangle(LEVEL_X + 40, LEVEL_Y - 60, -20, true),
      ],
     //Level 14-2 (Berry 2 253)
      2:[
        OrangeSquare(LEVEL_X - 50, LEVEL_Y + 0, 0, true),
        OrangeSquare(LEVEL_X - 50, LEVEL_Y - 110, 0, true),
        PinkQuarterCircle(LEVEL_X - 60, LEVEL_Y - 0, 90, true),
        PinkQuarterCircle(LEVEL_X - 60, LEVEL_Y - 10, 180, true),
        PinkQuarterCircle(LEVEL_X + 60, LEVEL_Y - 0, 0, true),
        PinkQuarterCircle(LEVEL_X + 60, LEVEL_Y - 10, -90, true),
        YellowDiamond(LEVEL_X + 50, LEVEL_Y - 290, 45, true)
      ],
     //Level 14-3 (Hummingbird 245)
      3:[
        PinkQuarterCircle(LEVEL_X - 60, LEVEL_Y + 100, 180, true),
        PinkQuarterCircle(LEVEL_X - 60, LEVEL_Y - 10, 180, true),
        PinkQuarterCircle(LEVEL_X - 50, LEVEL_Y - 0, 0, true),
        PinkQuarterCircle(LEVEL_X + 50, LEVEL_Y - 10, 180, true),
        BlueRightTriangle(LEVEL_X + 60, LEVEL_Y - 110, 0, true),
      ]
    }
